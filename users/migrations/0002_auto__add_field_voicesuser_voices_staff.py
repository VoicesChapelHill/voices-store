...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoicesUser.voices_staff'
        db.add_column('users_voicesuser', 'voices_staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoicesUser.voices_staff'
        db.delete_column('users_voicesuser', 'voices_staff')
